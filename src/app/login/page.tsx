...
const Login: React.FC = () => {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-sans text-slate-900 dark:text-slate-50 antialiased min-h-screen flex flex-col relative overflow-hidden">
      {/* Background Blobs */}
      <div
        className="absolute top-[-20%] left-[20%] w-[500px] h-[500px] bg-primary/20 rounded-full blur-[120px] pointer-events-none animate-pulse"
        style={{ animationDuration: '4s' }}
      ></div>
      <div className="absolute bottom-[-20%] right-[10%] w-[400px] h-[400px] bg-emerald-500/10 rounded-full blur-[100px] pointer-events-none"></div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center animate-fade-in-quick delay-300">
                <input
                  ...
                  className="w-4 h-4 text-primary bg-slate-50 dark:bg-input-bg border-slate-200 dark:border-border-dark rounded focus:ring-primary focus:ring-offset-0 cursor-pointer"
                />
                <label
                  htmlFor="remember-me"
